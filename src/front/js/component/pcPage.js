...
const PcPage = () => {
  ...
  useEffect(() => {
    ...
    setProducts([
      ...
      { id: 2, name: "Cargador Rápido", description: "Cargador rápido compatible con varios dispositivos", price: 50, image: "https://res.cloudinary.com/dese5jn5f/image/upload/v1731620156/159581-800-800_td2spj_mwodnm.png", category: "Accesorios" },
      { id: 3, name: "Cable USB-C", description: "Cable de carga rápida para dispositivos USB-C", price: 25, image: "https://res.cloudinary.com/dese5jn5f/image/upload/v1731620156/159581-800-800_td2spj_mwodnm.png", category: "Accesorios" },
