...
const ProductsPage = () => {
  ...
  useEffect(() => {
    ...
    setProducts([
      { id: 1, name: "Producto", description: "Cargador Iphone 14,15,16 ", price: 100, image: "https://res.cloudinary.com/dese5jn5f/image/upload/v1731458754/31T5DwGwEkS._AC_SL1000_-removebg-preview_qu1xof.png", category: "Electrónica" },
