			...
			<div className="container-fluid">
				...
				<ul className="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<form className="container-fluid justify-content-center" role="search">
						...
						<button className="btn btn-outline-light" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fillRule="currentColor" className="bi bi-search" viewBox="0 0 16 16">
